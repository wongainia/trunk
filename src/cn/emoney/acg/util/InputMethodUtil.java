...
public class InputMethodUtil {
     ...
     * @return void
     */
    public static void switchSoftKeyBoard(PageImpl pageImpl) {
        InputMethodManager imm = (InputMethodManager) pageImpl.getContext().getSystemService(Context.INPUT_METHOD_SERVICE);
     ...
     * @param editText
     */
    public static void openInputMethod(PageImpl pageImpl) {
        InputMethodManager imm = (InputMethodManager) pageImpl.getContext().getSystemService(Context.INPUT_METHOD_SERVICE);
        imm.toggleSoftInput(InputMethodManager.SHOW_IMPLICIT, InputMethodManager.HIDE_NOT_ALWAYS);
    }
     ...
     * @return void
     */
    public static boolean closeSoftKeyBoard(PageImpl pageImpl) {
        InputMethodManager imm = (InputMethodManager) pageImpl.getContext().getSystemService(Context.INPUT_METHOD_SERVICE);
        // 得到InputMethodManager的实例
        boolean bRet = imm.isActive();
        if (bRet) {
            // 如果存在关闭
            if (pageImpl.getActivity().getCurrentFocus() != null) {
                imm.hideSoftInputFromWindow(pageImpl.getActivity().getCurrentFocus().getWindowToken(), InputMethodManager.HIDE_NOT_ALWAYS);
                return true;
            } else {
                return false;
            }
