...
public class CandleStickPackage extends QuotePackageImpl {
	private CandleStick_Reply mReply = null;

	public CandleStickPackage(DataHeadImpl head) {
		super(head);
	}
	...
	public boolean readData(byte[] data, int arg1, int arg2) {
		try {
			mReply = CandleStick_Reply.parseFrom(data);
	...
	public CandleStick_Reply getResponse() {
		return mReply;
	}
