...
import cn.emoney.acg.view.CustomEditText.DrawableClickListener.DrawablePosition;
    ...
    public boolean onTouchEvent(MotionEvent event) {
        ...
        if (event.getAction() == MotionEvent.ACTION_DOWN) {
            ...
            if (drawableRight != null) {
                ...
                /**
                 * IF USER CLICKS JUST OUT SIDE THE RECTANGLE OF THE DRAWABLE THAN ADD X AND
                 * SUBTRACT THE Y WITH SOME VALUE SO THAT AFTER CALCULATING X AND Y CO-ORDINATE LIES
                 * INTO THE DRAWBABLE BOUND. - this process help to increase the tappable area of
                 * the rectangle.
                 */
                x = (int) (actionX + extraTapArea);
                y = (int) (actionY - extraTapArea);
                ...
                /**
                 * Since this is right drawable subtract the value of x from the width of view. so
                 * that width - tappedarea will result in x co-ordinate in drawable bound.
                 */
                x = getWidth() - x;
